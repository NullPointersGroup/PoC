...
3. A quel punto navigare la cartella .venv fino a selezionare il file `.venv/bin/python3.xx` o `.venv\Scripts\python3.xx.exe` dove xx è la versione più recente installata nel vostro sistema (solitamente 13 o 14)
